...
extends mmajkka {
    ...
    public final void AMajakk(int var1_1) {
        ...
        for (int n2 = 0; n2 < n; ++n2) {
            byArray[n2] = (byte)((byArray[n2] & 255) >>> var1_1);
        }
    }
    ...
    public final void aMajakk(int var1_1) {
        byte[] byArray = this.AmaJakK;
        byte[] byArray2 = this.aMAjakK;
        int n = var1_1 < -256 ? -256 : (var1_1 < 256 ? var1_1 : 256);
        System.arraycopy(kmajkka.amaJakK, n + 256, byArray, 128, 128);
        System.arraycopy(kmajkka.amaJakK, n + 384, byArray, 0, 128);
        int n2 = this.amAjakK * this.AMAjakK;
        for (int n3 = 0; n3 < n2; ++n3) {
            byArray2[n3] = byArray[byArray2[n3] + 128];
        }
    }
